...
const propiedades_alquiler = [
    ...
    {
        nombre: 'Casa de campo con jardín amplio',
        src: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YXBhcnRtZW50fGVufDB8MHwwfHx8MA%3D%3D&auto=format&fit=crop&w=700&q=60',
        descripcion: 'Hermosa casa de campo con un jardín amplio y vistas a la naturaleza',
    ...
    propiedades.forEach(propiedad => {
        html += `
            <div class="propiedad">
                ...
                <p><strong>Habitaciones:</strong> ${propiedad.habitaciones} | <strong>Baños:</strong> ${propiedad.banos}</p>
...
document.addEventListener('DOMContentLoaded', () => {
            // Para mostrar solo las primeras 3 propiedades en la página principal
